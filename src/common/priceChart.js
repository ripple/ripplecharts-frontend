...
function PriceChart(options) {
  ...
  function showDetails() {
    ...
    if (d) {
      if (rippleAmount) {
        open = rippleAmount(d.open, counter.currency);
        high = rippleAmount(d.high, counter.currency);
        low = rippleAmount(d.low, counter.currency);
        close = rippleAmount(d.close, counter.currency);
        vwap = rippleAmount(d.vwap, counter.currency);
        volume = rippleAmount(d.baseVolume, base.currency);
